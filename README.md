...
$$\frac{d\Phi_n(r)}{dr} = -\dfrac{V_0^2 d^{2n}}{r_c} \dfrac{(r/r_c)^2 (1 + r/r_c)^{-(2n + 1)}}{1 + (r/r_c)^2}\sum_{i=0}^{2n} C(i,n) \left( \frac{x}{d} \right)^i$$

where $C(i,n)=i+1$ if $0\leq i \leq n$ and $C(i,n)=2n-i+1$ if $n\leq i \leq 2n$
